...
func_detect_start(){
   ...
   #${DIR}/simpleperf stat -o /sdcard/stats/perf.${suite}.${test}.stat -e instructions,cpu-cycles --cpu 7 --app org.chromium.content_shell_apk &
...
do
  ...
  do
    ...
    taskset 80 am start -a android.intent.action.VIEW -n org.chromium.content_shell_apk/.ContentShellActivity -d "$optional_url"
